...
// Store the original positions of the planes
...
const animate = () => {
  ...
  if (rotateAroundGroup) {
    group.rotation.y = Math.cos(elapsedTime) * 0.1; // Adjust the rotation speed
    group.rotation.x = Math.sin(elapsedTime) * 0.05; // Adjust the rotation speed
  }
};
